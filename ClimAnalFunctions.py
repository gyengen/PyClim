...
#XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX########
# THIS FUNCTION CALCULATE THE GROUND TEMPERATURE
#XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX########
...
#def sunrise_time(dec, lat, jday):
#    day_length=max(0,daylength(lat,dec))
#    SStime = min(24,(12+day_length/2)+time_diff(longitude,timezone,jday))
#    SRtime = max(1,SStime-day_length)
#    return SStime, SRtime
